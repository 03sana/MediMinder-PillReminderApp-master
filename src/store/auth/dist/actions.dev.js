...
exports.initUserAuthStateListener = initUserAuthStateListener;
...
function initUserAuthStateListener(dispatch) {
  return (0, _auth.onAuthStateChanged)(_firebase.auth, function (user) {
    if (user && !user.emailVerified && user.providerData.map(function (provider) {
